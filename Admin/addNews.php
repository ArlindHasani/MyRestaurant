...
<html lang="en">
    ...
    <body>
        ...
        <section id="profile">
            ...
            <h4 class="montserrat_paragraph">Make sure to fill all the fields with the correct information!</h4>
            ...
            <div class="editProfileContainer">
                <div class="editProfileContent">
                    <div id="form">
                        <form  name="adminAddNews" onsubmit="return validateEditNews()" 
                        action= "../AdminFunctions/addNewsVerification.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="montserrat_small_paragraph_2">Title</label>
                                <input type="text" name="editNewsTitle" class="" placeholder="Minimum 8 characters"/>
                                <div  class="error-hint hidden">Title is too short or empty</div>
                            </div>
                            <div class="form-group">
                                <label class="montserrat_small_paragraph_2">Content</label>
                                <textarea name="editNewsContent" class="editNewsTextArea" placeholder="Minimum 20 characters"></textarea>
                            ...
                            <div class="editProfileActions">
                                <button name="addNews" type="submit" class="button_type3 addNews">Add</button>
                                <button onclick="cancelNewsEdit()" type="submit" class="button_type3 cancelAddNews">Cancel</button>
                            </div>
                        </form>
                    </div> 
                </div>
